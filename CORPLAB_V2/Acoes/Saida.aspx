            ...
            <div style="padding-bottom: 3%;">
                <div class="insercoes">
                    ...
                    <div style="margin-top: 10%;" runat="server" id="divAmostra" visible="false">
                        <asp:Label runat="server" ID="lblTipoSaida" Text="Amostra a retirar" />
                        <asp:Panel runat="server" DefaultButton="btAmostra" style="margin-top: 10px">
                            ...
                            <div style="margin-top: 3%;">
                                <asp:CheckBox runat="server" ID="ckbRetiraCaixa" Text="Retirar Caixa" AutoPostBack="true" OnCheckedChanged="ckbRetiraCaixa_CheckedChanged" />
                            </div>
                        </asp:Panel>
                    </div>
                ...
                <div runat="server" id="divInicio" visible="false">
                    ...
                    <div class="contBt">                       
                        <asp:Button runat="server" ID="btInicio" OnClick="btInicio_Click" CssClass="bt" Text="Início" />
                    </div>
                </div>
            </div>
            <div class="rodape">
